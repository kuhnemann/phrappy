...
class ProjectTemplateOperations:
    ...
    def create_custom_fields_on_project_template(
        self,
    ...
    def create_project_from_template_v2(
        ...
        try:
            ...
            if isinstance(data, dict):
                # try to coerce missing/None discriminator to a benign default
                disc = "userRole"
    ...
    def delete_custom_field_of_project_template(
        self,
    ...
    def edit_custom_field_on_project_template(
        self,
        field_instance_uid: str,
        project_template_uid: str,
    ...
    def edit_custom_fields_on_project_template(
        self,
        project_template_uid: str,
    ...
    def get_custom_field_of_project_template(
        self,
        field_instance_uid: str,
        project_template_uid: str,
        phrase_token: Optional[str] = None,
    ...
    def get_custom_fields_page_of_project_template(
        self,
        project_template_uid: str,
    ...
    def get_project_template_pre_translate_settings_v4(
        self,
        project_template_uid: str,
        phrase_token: Optional[str] = None,
    ) -> PreTranslateSettingsV4Dto:
    ...
    def update_project_template_pre_translate_settings_v4(
        self,
        project_template_uid: str,
