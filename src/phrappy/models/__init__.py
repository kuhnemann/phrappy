from .phrase_tms_api_models import (
    ...
    CreateProjectTemplateReferenceFileNoteDto,
    CreateProjectTemplateReferenceFilesRequest,
    CreateProjectV3Dto,
    ...
    ProjectTemplateReferenceFileReference,
