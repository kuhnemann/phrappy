...
class QualityAssuranceOperations:
    ...
    async def add_ignored_warnings(
        self,
        job_uid: str,
        project_uid: str,
    ...
    async def add_ignored_warnings_v2(
        self,
        project_uid: str,
    ...
    async def delete_ignored_warnings(
        self,
        job_uid: str,
        project_uid: str,
        update_ignored_warnings_dto: Optional[UpdateIgnoredWarningsDto | dict] = None,
    ...
    async def delete_ignored_warnings_v2(
        self,
        project_uid: str,
        update_ignored_warnings_dto2: Optional[UpdateIgnoredWarningsDto2 | dict] = None,
        phrase_token: Optional[str] = None,
    ...
    async def enabled_quality_checks_for_job(
        self,
        job_uid: str,
        project_uid: str,
        phrase_token: Optional[str] = None,
    ...
    async def enabled_quality_checks_for_project(
        self,
        project_uid: str,
        phrase_token: Optional[str] = None,
    ) -> QualityAssuranceChecksDtoV2:
    ...
    async def get_lqa_profile_authors(
        self,
        phrase_token: Optional[str] = None,
    ) -> UserReference:
        """
    ...
    async def get_lqa_profile_authors_v2(
        self,
    ...
    async def get_qa_settings_for_job_part_v4(
        self,
        job_uid: str,
        project_uid: str,
        phrase_token: Optional[str] = None,
    ...
    async def get_qa_settings_for_project_v4(
        self,
        project_uid: str,
        phrase_token: Optional[str] = None,
    ) -> QualityAssuranceChecksDtoV4:
    ...
    async def run_qa_for_job_part_v3(
        self,
        job_uid: str,
        project_uid: str,
    ...
    async def run_qa_for_job_part_v4(
        self,
        job_uid: str,
        project_uid: str,
        quality_assurance_run_dto_v3: Optional[QualityAssuranceRunDtoV3 | dict] = None,
    ...
    async def run_qa_for_job_parts_v3(
        self,
        project_uid: str,
    ...
    async def run_qa_for_job_parts_v4(
        self,
        project_uid: str,
        quality_assurance_batch_run_dto_v3: Optional[
            QualityAssuranceBatchRunDtoV3 | dict
    ...
    async def run_qa_for_segments_v3(
        self,
        project_uid: str,
    ...
    async def run_qa_for_segments_v4(
        self,
        project_uid: str,
        quality_assurance_segments_run_dto_v3: Optional[
            QualityAssuranceSegmentsRunDtoV3 | dict
    ...
    async def update_ignored_checks(
        self,
        job_uid: str,
        project_uid: str,
