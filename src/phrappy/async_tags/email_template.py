...
class EmailTemplateOperations:
    ...
    async def get_org_email_template(
        self,
        template_uid: str,
        ...
        return OrganizationEmailTemplateDto(**r.json())
        


    async def list_org_email_templates(
        self,
        ...
        return PageDtoOrganizationEmailTemplateDto(**r.json())
