...
class ProjectReferenceFileOperations:
    ...
    async def batch_delete_project_template_reference_files(
        self,
    ...
    async def batch_download_project_template_reference_files(
        self,
        project_template_uid: str,
        project_template_reference_files_request_dto: Optional[
            ProjectTemplateReferenceFilesRequestDto | dict
    ...
    async def create_project_template_reference_files(
        self,
        file: bytes,
        project_template_uid: str,
    ...
    async def download_project_template_reference(
        self,
        project_template_uid: str,
    ...
    async def list_project_template_reference_files(
        self,
        project_template_uid: str,
        filename: Optional[str] = None,
